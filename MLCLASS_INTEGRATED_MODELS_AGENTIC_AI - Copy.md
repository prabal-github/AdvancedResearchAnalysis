...
Endpoint Context: http://127.0.0.1:5008/vs_terminal_MLClass
...
```json
{
  ...
  "results": [ {"symbol": "RELIANCE", "projected_price": 2540.7, "confidence": 0.62 } ],
...
### Quote Object
```json
{ "symbol":"RELIANCE", "price":2541.25, "change_pct":0.47, "time":"2025-09-11T08:10:00Z" }
```
### Forecast Object
```json
{ "symbol":"RELIANCE", "model":"stock_price_predictor", "projected":2555.4, "confidence":0.61, "horizon_min":240 }
```
### Risk Stats Object
```json
{ "symbol":"RELIANCE", "risk_score":6.2, "volatility_est":0.23, "flags":["elevated_vol"] }
```
...
3. Launch Flask: `python app.py` (ensure port 5008).
4. Open UI: http://127.0.0.1:5008/vs_terminal_MLClass
