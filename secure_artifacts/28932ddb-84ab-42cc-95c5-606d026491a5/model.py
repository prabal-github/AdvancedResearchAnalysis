...
def run_analysis_demo(max_stocks=5):
    ...
    if hasattr(model, 'run_analysis'):
        return model.run_analysis() if hasattr(model, "stocks") and len(model.stocks) > 5 else print("Demo complete with 5 stocks")
...
if __name__ == "__main__":
    ...
    model.run_analysis() if hasattr(model, "stocks") and len(model.stocks) > 5 else print("Demo complete with 5 stocks")
