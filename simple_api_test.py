...
login_resp = session.get("http://127.0.0.1:80/demo_investor_login?investor_id=INV938713")
...
if login_resp.status_code == 200:
    ...
    api_resp = session.get("http://127.0.0.1:80/api/subscriber/portfolio_metrics")
    ...
    dash_resp = session.get("http://127.0.0.1:80/subscriber_dashboard")
