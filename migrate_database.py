...
def main():
    ...
    print("   Investor Login: http://localhost:5008/investor_dashboard")
    print("   Demo Investor: demo@investor.com / demo123")
    print("   Admin Panel: http://localhost:5008/admin_dashboard?admin_key=admin123")
    print("   Sample Analyst Profile: http://localhost:5008/analyst/SampleAnalyst/profile")
    print("\n🎯 New Features Added:")
