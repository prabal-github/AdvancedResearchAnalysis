...
Models market reactions to RBI monetary policy committee decisions and repo rate changes.
...
# Configuration
INDIAN_STOCKS = ['HDFCBANK.NS', 'ICICIBANK.NS', 'SBIN.NS', 'KOTAKBANK.NS', 'AXISBANK.NS', 'BAJFINANCE.NS', 'M&M.NS', 'MARUTI.NS']
US_INDICES = ['SPY', 'QQQ', 'DIA', 'IWM']  # SPY, NASDAQ, DOW, Russell 2000

class RBIMonetaryPolicyMarketReactionModelModel:
    def __init__(self):
        self.model_name = "RBI Monetary Policy Market Reaction Model"
        self.description = "Models market reactions to RBI monetary policy committee decisions and repo rate changes."
...
def main():
    ...
    model = RBIMonetaryPolicyMarketReactionModelModel()
