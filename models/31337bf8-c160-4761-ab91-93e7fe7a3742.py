...
Models the spillover effects of European economic crises on Indian pharmaceutical and chemical sectors.
...
# Configuration
INDIAN_STOCKS = ['DRREDDY.NS', 'SUNPHARMA.NS', 'CIPLA.NS', 'LUPIN.NS', 'UPL.NS', 'PIDILITIND.NS', 'ASIANPAINT.NS']
US_INDICES = ['SPY', 'QQQ', 'DIA', 'IWM']  # SPY, NASDAQ, DOW, Russell 2000

class EuropeanEconomicCrisisSpilloverModelModel:
    def __init__(self):
        self.model_name = "European Economic Crisis Spillover Model"
        self.description = "Models the spillover effects of European economic crises on Indian pharmaceutical and chemical sectors."
...
def main():
    ...
    model = EuropeanEconomicCrisisSpilloverModelModel()
