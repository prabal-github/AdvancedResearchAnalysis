...
Assesses the impact of global supply chain disruptions on Indian manufacturing and IT sectors.
...
# Configuration
INDIAN_STOCKS = ['RELIANCE.NS', 'TCS.NS', 'INFY.NS', 'WIPRO.NS', 'LT.NS', 'BAJAJ-AUTO.NS', 'MARUTI.NS', 'TATAMOTORS.NS', 'TATASTEEL.NS', 'HINDALCO.NS']
US_INDICES = ['SPY', 'QQQ', 'DIA', 'IWM']  # SPY, NASDAQ, DOW, Russell 2000

class GlobalSupplyChainDisruptionAnalyzerModel:
    def __init__(self):
        self.model_name = "Global Supply Chain Disruption Analyzer"
        self.description = "Assesses the impact of global supply chain disruptions on Indian manufacturing and IT sectors."
...
def main():
    ...
    model = GlobalSupplyChainDisruptionAnalyzerModel()
