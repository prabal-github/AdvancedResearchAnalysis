...
Evaluates how China's economic performance affects Indian commodity and export-oriented companies.
...
# Configuration
INDIAN_STOCKS = ['RELIANCE.NS', 'TATASTEEL.NS', 'HINDALCO.NS', 'VEDL.NS', 'COALINDIA.NS', 'SAIL.NS', 'NMDC.NS', 'JSWSTEEL.NS']
US_INDICES = ['SPY', 'QQQ', 'DIA', 'IWM']  # SPY, NASDAQ, DOW, Russell 2000

class ChinaEconomicSlowdownImpactonIndiaModel:
    def __init__(self):
        self.model_name = "China Economic Slowdown Impact on India"
        self.description = "Evaluates how China's economic performance affects Indian commodity and export-oriented companies."
...
def main():
    ...
    model = ChinaEconomicSlowdownImpactonIndiaModel()
