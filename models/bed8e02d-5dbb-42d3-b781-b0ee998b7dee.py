...
Measures the impact of US Dollar strength on Indian export-oriented companies and software exporters.
...
# Configuration
INDIAN_STOCKS = ['TCS.NS', 'INFY.NS', 'DRREDDY.NS', 'SUNPHARMA.NS', 'CIPLA.NS', 'LUPIN.NS', 'TECHM.NS', 'WIPRO.NS']
US_INDICES = ['SPY', 'QQQ', 'DIA', 'IWM']  # SPY, NASDAQ, DOW, Russell 2000

class DollarStrengthImpactonIndianExportersModel:
    def __init__(self):
        self.model_name = "Dollar Strength Impact on Indian Exporters"
        self.description = "Measures the impact of US Dollar strength on Indian export-oriented companies and software exporters."
...
def main():
    ...
    model = DollarStrengthImpactonIndianExportersModel()
