...
Analyzes the impact of trade war tensions between India and USA on stock markets, with focus on export-dependent sectors.
...
# Configuration
INDIAN_STOCKS = ['RELIANCE.NS', 'TCS.NS', 'HDFCBANK.NS', 'INFY.NS', 'HINDUNILVR.NS', 'ITC.NS', 'SBIN.NS', 'BHARTIARTL.NS', 'KOTAKBANK.NS', 'LT.NS']
US_INDICES = ['SPY', 'QQQ', 'DIA', 'IWM']  # SPY, NASDAQ, DOW, Russell 2000

class IndiaUSTradeWarImpactAnalyzerModel:
    def __init__(self):
        self.model_name = "India-US Trade War Impact Analyzer"
        self.description = "Analyzes the impact of trade war tensions between India and USA on stock markets, with focus on export-dependent sectors."
