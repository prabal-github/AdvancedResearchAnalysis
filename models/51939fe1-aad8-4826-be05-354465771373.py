...
Analyzes the correlation between US presidential elections and global market volatility, with emphasis on Indian ADRs.
...
# Configuration
INDIAN_STOCKS = ['INFY.NS', 'TCS.NS', 'WIPRO.NS', 'HCL.NS', 'TECHM.NS', 'RELIANCE.NS', 'DRREDDY.NS', 'TATAMOTORS.NS']
US_INDICES = ['SPY', 'QQQ', 'DIA', 'IWM']  # SPY, NASDAQ, DOW, Russell 2000

class USElectionImpactonGlobalMarketsModel:
    def __init__(self):
        self.model_name = "US Election Impact on Global Markets"
        self.description = "Analyzes the correlation between US presidential elections and global market volatility, with emphasis on Indian ADRs."
...
def main():
    ...
    model = USElectionImpactonGlobalMarketsModel()
