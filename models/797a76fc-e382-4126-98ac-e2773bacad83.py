...
Analyzes the impact of global inflation trends on Indian consumer goods and banking sectors.
...
# Configuration
INDIAN_STOCKS = ['HDFCBANK.NS', 'ICICIBANK.NS', 'SBIN.NS', 'HINDUNILVR.NS', 'ITC.NS', 'BRITANNIA.NS', 'BAJFINANCE.NS']
US_INDICES = ['SPY', 'QQQ', 'DIA', 'IWM']  # SPY, NASDAQ, DOW, Russell 2000

class GlobalInflationTrendImpactAnalyzerModel:
    def __init__(self):
        self.model_name = "Global Inflation Trend Impact Analyzer"
        self.description = "Analyzes the impact of global inflation trends on Indian consumer goods and banking sectors."
...
def main():
    ...
    model = GlobalInflationTrendImpactAnalyzerModel()
