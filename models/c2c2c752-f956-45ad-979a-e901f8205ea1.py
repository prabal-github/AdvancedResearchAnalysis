...
Predicts Indian market movements based on crude oil price volatility and geopolitical tensions in Middle East.
...
# Configuration
INDIAN_STOCKS = ['RELIANCE.NS', 'ONGC.NS', 'BPCL.NS', 'IOC.NS', 'HINDPETRO.NS', 'MARUTI.NS', 'BAJAJ-AUTO.NS', 'EICHERMOT.NS']
US_INDICES = ['SPY', 'QQQ', 'DIA', 'IWM']  # SPY, NASDAQ, DOW, Russell 2000

class OilPriceVolatilityIndianMarketPredictorModel:
    def __init__(self):
        self.model_name = "Oil Price Volatility Indian Market Predictor"
        self.description = "Predicts Indian market movements based on crude oil price volatility and geopolitical tensions in Middle East."
...
def main():
    ...
    model = OilPriceVolatilityIndianMarketPredictorModel()
