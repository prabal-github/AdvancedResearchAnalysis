...
Evaluates how Federal Reserve interest rate decisions and monetary policy changes affect Indian equity and currency markets.
...
# Configuration
INDIAN_STOCKS = ['NIFTY.NS', 'BANKNIFTY.NS', 'HDFCBANK.NS', 'ICICIBANK.NS', 'SBIN.NS', 'KOTAKBANK.NS', 'AXISBANK.NS', 'INDUSINDBK.NS']
US_INDICES = ['SPY', 'QQQ', 'DIA', 'IWM']  # SPY, NASDAQ, DOW, Russell 2000

class FederalReservePolicyImpactonIndianMarketsModel:
    def __init__(self):
        self.model_name = "Federal Reserve Policy Impact on Indian Markets"
        self.description = "Evaluates how Federal Reserve interest rate decisions and monetary policy changes affect Indian equity and currency markets."
...
def main():
    ...
    model = FederalReservePolicyImpactonIndianMarketsModel()
