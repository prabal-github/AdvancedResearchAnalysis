        ...
        if os.path.exists(SQLITE_DB_PATH):
            ...
            for table in ['portfolio_commentary', 'script_executions']:
                try:
                    ...
                    count_row = sqlite_cursor.fetchone()
                    sqlite_counts[table] = count_row[0] if count_row else 0
                except:
...
def main():
    ...
    logger.info(f"Target: postgresql://admin:***@3.85.19.80:5432/research")
    logger.info("")
    ...
    logger.info("1. Set environment variable: set RDS_DATABASE_URL=postgresql://admin:admin%%402001@3.85.19.80:5432/research")
    logger.info("2. Restart your Flask application")
    logger.info("3. Verify the application works with PostgreSQL")
